                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () async
                                    {
                                      ...
                                      await Navigator.push(context, MaterialPageRoute(builder: (context) => Profile(image: widget.image,name: widget.name,speciality: widget.specialist,doctorId: 3,),));
                                      animator();
                                    },
                                    child: CircleAvatar(
                                      radius: 25,
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  msgBox(size, "Use the Stick on other hand Fandit", "08:20",Colors.green.withOpacity(.1),Colors.grey),
                                  const SizedBox(height: 30,),
                                  Align(
                                    alignment: Alignment.topRight,
                                    child: msgBox(size, "Thanks doc!", "09:20",Colors.green.shade900,Colors.white),
                                  ),
                                  const SizedBox(height: 30,),
                                  Row(
                                  ...
                                  const SizedBox(height: 30,),
                                  msgBox(size, "Morning!\n\nHow the result did it\nwork well", "08:20",Colors.green.withOpacity(.1),Colors.grey),
                                  const SizedBox(height: 30,),
                                  Align(
                                    alignment: Alignment.topRight,
                                    child:
                                    msgBox(size, "Morning doc,Problem is\nsolved,Thanks doc", "08:25",Colors.green.shade900,Colors.white),
                                  ),
